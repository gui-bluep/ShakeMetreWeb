...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        /*
         * Activé : sans lui, dompdf embarque la police entière dans chaque document, ce qui
         * faisait 1,3 Mo de PDF pour un budget de 357 lignes dont l'essentiel était DejaVu Sans.
         * Un document imprimé n'utilise qu'une fraction des glyphes.
         */
